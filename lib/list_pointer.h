...
node_t *list_at(list_tuples *l, int position);
...
void list_insert(list_tuples *l, int index_i, int index_j, int T_iter, int position);
...
/// @param index_j Index j of port changed on local search
/// @param T_iter Number of iterations to restrict a solution - Tabu Search
void list_push_front(list_tuples *l, int index_i, int index_j, int T_iter);
...
/// @param index_j Index j of port changed on local search
/// @param T_iter Number of iterations to restrict a solution - Tabu Search
void list_push_back(list_tuples *l, int index_i, int index_j, int T_iter);
...
void list_erase(list_tuples *l, int position);

/// @brief Remove a node from first position of the list
/// @param l List to have node removed from
void list_pop_front(list_tuples *l);
